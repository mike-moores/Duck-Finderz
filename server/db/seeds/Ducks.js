export async function seed(knex) {
  ...
  await knex('Ducks').insert([
    ...
    },
    {
      id: 4,
      name: 'duck 4',
      image: '/images/pixel-rubber-duck-bubbles.png',
      rarity: 2,
    },
    { id: 5, name: 'duck 5', image: '/images/flamingo.png', rarity: 1 },
    { id: 6, name: 'duck 6', image: '/images/little-duck.png', rarity: 2 },
    { id: 7, name: 'duck 7', image: '/images/pixel-mallard.png', rarity: 2 },
    { id: 8, name: 'duck 8', image: '/images/knife-duck.png', rarity: 3 },
    {
      id: 9,
      name: 'duck 8',
